...
static struct config_item _config_item[] = {
	...
	CONF_INT_FUNC("nftset-timeout-multiplier", _dns_conf_group_int,
				  group_member(ipset_nftset.nftset_timeout_multiplier), 0, CONF_INT_MAX),
	CONF_INT_FUNC("nftset-timeout-grace", _dns_conf_group_int, group_member(ipset_nftset.nftset_timeout_grace), 0,
				  CONF_INT_MAX),
	CONF_INT_FUNC("nftset-timeout-min", _dns_conf_group_int, group_member(ipset_nftset.nftset_timeout_min), 0,
				  CONF_INT_MAX),
